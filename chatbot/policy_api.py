...
class PolicyAPI:
    ...
    def __init__(self):
        ...
        self.citation_manager = CitationManager() # Initialize citation manager here
    ...
    def get_policy_response(self, question: str, conversation_history: Optional[List[Dict[str, Any]]] = None, location_context: Optional[str] = None, include_citations: bool = True) -> str:
        """
        ...
        return self._format_policy_response(question, state_code, policy_data, include_citations)
    ...
    def _format_policy_response(self, question: str, state_code: str, policy_data: Dict[str, Any], include_citations: bool) -> str:
        """
        ...
        Include appropriate citations to the Abortion Policy API if include_citations is True.
        ...
        try:
            ...
            return self.citation_manager.add_citation_to_text(response, "abortion_policy_api", include_citations)
        except Exception as e:
    ...
    def handle_policy_query(self, content: str, state: str = None, conversation_id: str = None, include_citations: bool = True) -> str:
        """
        Handle policy questions by calling the Abortion Policy API

        Args:
            content (str): The user's question
            state (str, optional): The U.S. state context
            conversation_id (str, optional): Conversation ID for tracking
            include_citations (bool): Whether to include citations in the response

        Returns:
            str: The formatted response with or without citation
        """
        response_text = self.get_policy_response(content, None, state, include_citations)
        return response_text


class CitationManager:
    def add_citation_to_text(self, text: str, source: str, include_citations: bool = True) -> str:
        if include_citations:
            if source == "abortion_policy_api":
...
from chatbot.gpt_integration import GPTModel #Import GPTModel here