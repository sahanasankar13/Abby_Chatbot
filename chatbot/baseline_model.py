...
class BaselineModel:
    ...
    def process_message(self, message, conversation_id=None, persona="baseline"):
        ...
        Args:
            ...
            persona (str, optional): Persona to use
        ...
        try:
            ...
            # Only use GPT for emotional support questions
            if classification.get("is_emotional", False):
                gpt_response = self.gpt_model.get_response(message)
                return {
                    "text": gpt_response,
                    "citations": [],
                    "citation_objects": [],
            ...
            # For all other questions, use BERT RAG model
            response = self.bert_rag.get_response(message)
            return {
                "text": response,
